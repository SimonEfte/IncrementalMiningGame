...
public class AudioOptionsManager : MonoBehaviour
{
    ...
    public void Start()
    {
        ...
        if (audioSlider.value == 0.0001f) { soundEffectolume = -80; MuteAudio(); AudioManager.Instance.UpdateMixerVolume(); }
        if (musicSlider.value == 0.0001f) { musicVolume = -80; MuteAudio(); AudioManager.Instance.UpdateMixerVolume(); }
    }
